...
namespace PathTracerNET
{
	internal class Program
	{
		...
		private static void Main(string[] args)
		{
			...
			PTObject light = PTObject.Sphere(new Vec3(0f, 3f, 0f), 1.8f, lightMaterial);
			...
			PTObject.RenderSceneChunked(WIDTH, HEIGHT, SAMPLES, fname, new Vec3(2f, 1f, -2f), new Vec3(-2f, 0f, 2f), new Vec3(0f, 1f, 0f), (float)Math.PI / 3.4f, (float)WIDTH / HEIGHT, scene);
