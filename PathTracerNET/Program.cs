...
namespace PathTracerNET
{
	...
	{
		private const int WIDTH = 5120, HEIGHT = 2560, SAMPLES = 10;
		...
		private static void Main(string[] args)
		{
			...
			PTObject light = PTObject.Sphere(new Vec3(0.4f, 3f, -0.4f), 2.4f, lightMaterial);
			...
			PTObject.RenderSceneChunked(WIDTH, HEIGHT, SAMPLES, fname, new Vec3(2f, 1f, -2f) - new Vec3(0f, 0.2f, 0f), new Vec3(-2f, 0f, 2f), new Vec3(0f, 1f, 0f), (float)Math.PI / 3.4f, (float)WIDTH / HEIGHT, scene);
