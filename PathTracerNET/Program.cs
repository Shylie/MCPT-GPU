...
namespace PathTracerNET
{
	...
	{
		private const int WIDTH = 512, HEIGHT = 512, SAMPLES = 50, CHUNK_SIZE = 32;
		...
		private static void Main(string[] args)
		{
            ...
            triangle = PTObject.Rotation((float)Math.PI / 12.8f, PTObject.Alignment.Z, triangle);

            PTObject scene = PTObject.HittableList(light, sphere, cube, otherCube, otherSphere, triangle);
