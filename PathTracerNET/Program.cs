...
namespace PathTracerNET
{
	...
	{
		private const int WIDTH = 512, HEIGHT = 256, SAMPLES = 500;
		...
		private static void Main(string[] args)
		{
			...
			PTObject light = PTObject.Sphere(0.4f, 3f, -0.4f, 2.4f, lightMaterial);
			PTObject sphere = PTObject.Sphere(0f, -100.1f, 0f, 100f, blueMatte);
			...
			PTObject.RenderSceneChunked(WIDTH, HEIGHT, SAMPLES, fname, 2f, 1f, -2f, -2f, 0f, 2f, 0f, 1f, 0f, (float)Math.PI / 3.4f, (float)WIDTH / HEIGHT, scene);
